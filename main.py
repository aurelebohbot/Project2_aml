...
def pipeline_tuning():
    ...
    tuner = kt.RandomSearch(HyperCNN(), objective=["loss"], max_trials=20)
    ...
    tuner.search(x_train, y_train, epochs=20, callbacks=callbacks)
...
def pipeline_training():
    ...
    model = tf.keras.models.load_model("best_model_training.h5")
